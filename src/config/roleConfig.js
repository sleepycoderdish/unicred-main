...
export const ROLE_CONFIG = {
  [ROLES.STUDENT]: {
    ...
    nav: [
      ...
      { label: 'Achievements',     path: '/student/achievements',     icon: 'TrendingUp' },
      { label: 'Internships',      path: '/student/internships',      icon: 'Building2' },
  ...
  [ROLES.FACULTY]: {
    ...
    nav: [
      ...
      { label: 'Achievements',     path: '/faculty/achievements',     icon: 'TrendingUp' },
      { label: 'Students',         path: '/hod/students',             icon: 'Users' },
  ...
  [ROLES.HOD]: {
    ...
    nav: [
      ...
      { label: 'Achievements',     path: '/hod/achievements',         icon: 'TrendingUp' },
      { label: 'Internships',      path: '/hod/internships',          icon: 'Building2' },
      { label: 'Students',         path: '/hod/students',             icon: 'Users' },
